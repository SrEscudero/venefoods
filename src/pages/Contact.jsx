    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 py-8 animate-fade-in pb-20">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4">
            <SocialBtn
              ...
              href="#"
              color="hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-500 hover:text-white"
              label="@venefoods"
            />
            <SocialBtn
            ...
            <SocialBtn
              icon={<Mail size={20} />}
              href="mailto:contacto@venefoods.com"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {/* Tarjeta WHATSAPP */}
          <div className="bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-[2.5rem] p-8 text-white relative overflow-hidden group hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
            <div className="relative z-10">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white text-green-600 px-6 py-3 rounded-xl font-bold text-sm hover:bg-green-50 transition-all shadow-lg"
              >
                Iniciar Chat
              </a>
            </div>
          ...
          {/* Tarjeta UBICACIÓN */}
          <div className="bg-white/80 backdrop-blur-sm rounded-[2.5rem] p-8 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:bg-white transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-xl shadow-slate-900/20 transition-all hover:shadow-2xl">
        ...
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-slate-900 mb-8 tracking-tight">
...
function SocialBtn({ icon, href, color, label }) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`flex items-center gap-2 px-4 py-2 rounded-full bg-white text-gray-600 border border-gray-200 transition-all duration-300 shadow-sm hover:shadow-md ${color}`}
    >
      {icon}
...
function FaqItem({ question, answer }) {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 overflow-hidden transition-all hover:shadow-md">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex justify-between items-center p-5 text-left font-bold text-slate-800 hover:bg-gray-50/50 transition-colors"
      >
        {question}
        <ChevronDown
          size={20}
      ...
      <div
        className={`bg-gray-50/50 px-5 text-gray-600 text-sm leading-relaxed transition-all duration-300 overflow-hidden ${
